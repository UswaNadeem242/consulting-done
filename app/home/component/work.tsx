...
import { PenTool, Layout, Send, Star } from 'lucide-react';
                    ...
                    <div className="w-full lg:w-[55%] flex flex-col gap-6">
                        {cardsData.map((card, index) => (
                            <div key={index} className="flex items-center w-full relative">
                                ...
                                {/* Icon circle */}
                                <div className="w-20 h-20 rounded-full bg-consult-sky flex items-center justify-center text-white shrink-0 relative z-10 shadow-lg">
                                    {card.icon}
                                    {/* Small white dot */}
                                ...
                                {/* Dotted line */}
                                <div className="w-10 sm:w-16 h-0 border-t-[3px] border-dotted border-gray-500/60 shrink-0 mx-2"></div>

                                {/* The card */}
                                <div className="flex-grow bg-consult-blue rounded-xl p-8 relative ml-4 sm:ml-6  transition-colors cursor-pointer group">
                                    {/* Number badge */}
                                    ...
                                    <p className="text-gray-300 text-sm leading-relaxed opacity-80">{card.description}</p>
                                </div>
